...
// Witte bottom nav: Home, Route, Hulp, Profiel
class AppBottomNav extends StatelessWidget {
  final int currentIndex;
  const AppBottomNav({super.key, required this.currentIndex});

  static const _routes = ['/home', '/map', '/help', '/profile'];
  static const _labels = ['Home', 'Route', 'Hulp', 'Profiel'];
  static const _icons = [Icons.home_rounded, Icons.location_on_rounded, Icons.favorite_rounded, Icons.person_rounded];
